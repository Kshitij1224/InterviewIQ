              ...
              <motion.div
                ...
                {projects.length > 0 && (
                  <div>
                    ...
                    <ul className='list-disc list-inside tex-gray-600 space-y-1'>{projects.map((p, i) => (
                      <li key={i}>{p}</li>
                    ))}</ul>
                  </div>
                )}
                {skills.length > 0 && (
                  <div>
                    ...
                    <div className='flex flex-wrap gap-2'>{skills.map((s, i) => (
                      <span key={i} className='bg-green-100 text-green-700 p-3 py-1 rounded-full text-sm'>{s}</span>
                    ))}</div>
                  </div>
                )}
              </motion.div>
